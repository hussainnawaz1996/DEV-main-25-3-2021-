...
open class ADCountryPicker: UITableViewController {
    ...
    fileprivate func createSearchBar() {
        if self.tableView.tableHeaderView == nil {
            ...
            searchController.searchBar.barTintColor = Colors.WHITE
            searchController.searchBar.showsCancelButton = false
            //searchController.searchBar.backgroundColor = ThemeManager.shared.appTheme.baseColorInput
            let textFieldInsideSearchBar = searchController.searchBar.value(forKey: "searchField") as? UITextField
            textFieldInsideSearchBar?.textColor = Colors.BLACK
